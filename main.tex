...
\begin{center} \includegraphics[scale=0.5]{images/ampli.png} \end{center}
...
\begin{center} \includegraphics[scale=0.35]{images/ampli-ideal.png} \end{center}
...
\begin{center} \includegraphics[scale=0.4]{images/inverting.png} \end{center}
...
\begin{center} \includegraphics[scale=0.5]{images/ampli-ferme-freq.png} \end{center}
...
\begin{center} \includegraphics[scale=0.5]{images/quadripole.png} \end{center}

$$ \boxed{G_v = A_{vo} \frac{R_i}{R_i + R_s} \frac{R_L}{R_L + R_o}} $$

\subsection{Modèles de circuits pour amplificateurs}

\begin{center} \includegraphics[scale=0.45]{images/model-circuits.png} \end{center}

\subsection{Amplificateurs avec étages en cascade}

\begin{center} \includegraphics[scale=0.35]{images/ampli-cascade.png} \end{center}
...
\begin{center} \includegraphics[scale=0.5]{images/diode.png} \end{center}
...
\begin{center} \includegraphics[scale=0.35]{images/redresseur.png} \end{center}
...
\begin{center} \includegraphics[scale=0.4]{images/diode-relle.png} \end{center}


\subsection{Modèle}

\begin{center} \includegraphics[scale=0.4]{images/modele-diode.png} \end{center}
...
\begin{center} \includegraphics[scale=0.3]{images/model-sens-passant.png} \end{center}
...
<Résistance petit-signal (26mv/courant de polarisation) slide 11>
Pour le DC on fait avec l'exponentielle, pour le AC on remplace la diode par une résistance (rd)
...
\begin{center} \includegraphics[scale=0.4]{images/regu-ldo.png} \end{center}
...
\begin{center} \includegraphics[scale=0.5]{images/mos.png} \end{center}
...
\begin{center} \includegraphics[scale=0.4]{images/struct-mos.png} \end{center}

\subsubsection{Technologie MOS complémentaire ou CMOS}

\begin{center} \includegraphics[scale=0.4]{images/nmos-pmos.png} \end{center}
...
\begin{center} \includegraphics[scale=0.35]{images/symbol-nmos.png} \end{center}
...
\begin{center} \includegraphics[scale=0.45]{images/nmos-eq.png} \end{center}
